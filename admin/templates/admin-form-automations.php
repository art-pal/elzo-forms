...
$title_url = \ElzoForms\Utilities\Admin::get_pro_url('form_automations_title');
$learn_more_url = \ElzoForms\Utilities\Admin::get_pro_url('form_automations_button');
?>
<div class="elzo-forms-admin-search-section">
    <?php /* translators: %s is the plugin name. */ ?>
    <h3><?php printf(esc_html__('Automations are available in %s', 'elzo-forms'), '<a href="' . esc_url($title_url) . '" target="_blank" rel="noopener noreferrer">Elzo Forms PRO</a>'); ?></h3>
    <p>
